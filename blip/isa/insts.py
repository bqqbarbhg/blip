...
insts = [
    ...
    Inst("1110 0000 vvvv vvvv", "jnt v", imm_scale=2, imm_relative=True),
    Inst("1110 0001 vvvv vvvv", "jt v",  imm_scale=2, imm_relative=True),
    Inst("1110 0010 vvvv vvvv", "jnz v", imm_scale=2, imm_relative=True),
    Inst("1110 0011 vvvv vvvv", "jz v",  imm_scale=2, imm_relative=True),
    Inst("1110 0100 vvvv vvvv", "jnc v", imm_scale=2, imm_relative=True),
    Inst("1110 0101 vvvv vvvv", "jc v",  imm_scale=2, imm_relative=True),
    Inst("1110 0110 vvvv vvvv", "jno v", imm_scale=2, imm_relative=True),
    Inst("1110 0111 vvvv vvvv", "jo v",  imm_scale=2, imm_relative=True),
    Inst("1110 1000 vvvv vvvv", "jns v", imm_scale=2, imm_relative=True),
    Inst("1110 1001 vvvv vvvv", "js v",  imm_scale=2, imm_relative=True),
    Inst("1110 1010 vvvv vvvv", "jna v", imm_scale=2, imm_relative=True),
    Inst("1110 1011 vvvv vvvv", "ja v",  imm_scale=2, imm_relative=True),
    Inst("1110 1100 vvvv vvvv", "jnl v", imm_scale=2, imm_relative=True),
    Inst("1110 1101 vvvv vvvv", "jl v",  imm_scale=2, imm_relative=True),
    Inst("1110 1110 vvvv vvvv", "jng v", imm_scale=2, imm_relative=True),
    Inst("1110 1111 vvvv vvvv", "jg v",  imm_scale=2, imm_relative=True),
